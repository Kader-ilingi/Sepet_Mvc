...
{
    public NorthwindContext()//bunun amacı onconfiguring içerisindeki connectionstring'in devreye/kullanıma alınması içindir
    {
    }

    public NorthwindContext(DbContextOptions<NorthwindContext> options)//eğer servis katmanından bağlantı cümlesi fırlatılıyorsa fırlatılan options'ın dahil edilmesi içindir.
        : base(options)
    {
    }
...
//onconfiguring silindi.Onconfiguring içerisinde bulunan connectionstring tanımlanması program.cs içerisine taımlandı.
